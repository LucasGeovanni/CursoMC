...
import br.com.lucasgeovanni.cursomc.domain.ItemPedido;
...
import br.com.lucasgeovanni.cursomc.repositories.ItemPedidoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat3 = new Categoria(null, "Escritorio 2");
		Categoria cat4 = new Categoria(null, "Escritorio 3");
		Categoria cat5 = new Categoria(null, "Escritorio 4");
		Categoria cat6 = new Categoria(null, "Escritorio 5");
		Categoria cat7 = new Categoria(null, "Escritorio 6");
